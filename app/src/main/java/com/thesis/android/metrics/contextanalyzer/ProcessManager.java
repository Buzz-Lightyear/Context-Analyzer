...
public class ProcessManager
{
    ...
    /*
        This returns a list of applications whose processes currently reside in main memory.
    ...
    */
    ...
    public static class Process implements Parcelable, Comparable{
